...
Generates possible crystallographic plane combinations

Compares theoretical values with experimental inputs

Calculates error metrics

Outputs probable indexing solutions ranked by accuracy
